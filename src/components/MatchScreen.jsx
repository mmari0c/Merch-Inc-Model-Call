   ...
   return (
      <div className='w-full bg-white p-6 rounded-xl border-2 border-gray-200 flex flex-col items-center justify-center gap-4 h-fit mt-6 '>
         ...
         <div className='bg-gray-100 p-4 rounded-lg w-full'> 
            { role === 'model' ? (
            <p className='text-center text-gray-900'>Next Steps: Please wait for the designer to contact you with further details.</p>
         ) : (
            <p className='text-center text-gray-900'>Next Steps: Please reach out to the selected models to confirm availability, discuss design concepts, and schedule fittings.</p>
         )}
         </div>
      </div>
   )

...
function finalSelection({ index, name, modelNumber }) {
   return (
      <div className="bg-green-100 p-4 rounded-lg border border-green-200 flex items-center gap-3 justify-between md:flex-col lg:flex-row">
         ...
         <button className="py-2 px-4 rounded-lg hover:bg-red-100 hover:border-red-200 transition-colors md:w-full bg-green-100 md:border md:border-green-200  lg:w-auto lg:border-none">
